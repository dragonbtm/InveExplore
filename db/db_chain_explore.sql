...
CREATE TABLE `db_totals` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `number` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '数量',
  `type` int(2) NOT NULL COMMENT '类型:1消息数量 2账户数量',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `update_time` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='账户数量';
